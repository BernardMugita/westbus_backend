...
@router.post("/", response_model=LoanRepaymentResponse)
...
@router.get("/", response_model=LoanRepaymentResponse)
...
@router.get("/{repayment_id}", response_model=LoanRepaymentResponse)
...
@router.patch("/{repayment_id}", response_model=LoanRepaymentResponse)
...
@router.delete("/{repayment_id}", response_model=LoanRepaymentResponse)
