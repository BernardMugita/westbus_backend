...
@router.post("/add_revenue", response_model=RevenueLedgerResponse)
...
@router.post("/get_all_revenue", response_model=RevenueLedgerResponse)
...
@router.post("/get_revenue/{revenue_id}", response_model=RevenueLedgerResponse)
...
@router.post("/update_revenue/{revenue_id}", response_model=RevenueLedgerResponse)
...
@router.post("/delete_revenue/{revenue_id}", response_model=RevenueLedgerResponse)
