...
@router.post("/create_expense", response_model=ExpenseResponse)
...
@router.post("/get_all_expenses", response_model=ExpenseResponse)
...
@router.post("/get_expense/{expense_id}", response_model=ExpenseResponse)
...
@router.post("/update_expense/{expense_id}", response_model=ExpenseResponse)
...
@router.post("/delete_expense/{expense_id}", response_model=ExpenseResponse)
